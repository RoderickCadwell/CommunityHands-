...
struct TermsAndPoliciesView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            HStack {
                Button(action: {
                    // Log out to reset flow back to Welcome/Login
                ...
                // Invisible balance block for header centering
                Text("Back")
                    .font(.body)
                    .opacity(0)
            }
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    // MARK: - Legal Sections 1 through 17
                    Group {
                    ...
                    VStack(alignment: .leading, spacing: 14) {
                        ...
                        // Conditional Parent/Guardian Signature
                        if isUnder18 {
                            VStack(alignment: .leading, spacing: 6) {
            ...
            VStack(spacing: 14) {
                ...
                Button(action: {
                    // Update AuthViewModel state to trigger CustomerBioView next
    ...
    // Helper method to format legal text blocks cleanly
    ...
    // Validation rule: Ensures fields are signed & checkbox checked before proceeding
